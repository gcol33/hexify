...
— works with both grid systems through the same interface. This vignette
covers what H3 is, how to use it in hexify, and when to prefer it over
ISEA.
...
**Key difference from ISEA**: H3 cells are *not* equal-area. Cell area
varies by ~1.6$`\times`$ between the largest and smallest hexagons at
any given resolution, depending on latitude. For rigorous equal-area
analysis, use ISEA. For interoperability with H3 ecosystems, use
`type = "h3"`.
...
Then use
[`hexify()`](https://gcol33.github.io/hexify/reference/hexify.md) with
...
The standard hexify workflow applies to H3 grids. Here’s a complete
example using simulated species observations:
...
for bidirectional mapping between ISEA and H3 cell IDs. This is useful
when you work in ISEA for analysis but need to share results with H3
...
#> 1        42280 841e15bffffffff      2591.375    1753.175
#> 2        39597 841fb43ffffffff      2591.375    1569.205
#> 3        40823 841f1d5ffffffff      2591.375    1570.137
#> 4        39585 84390cbffffffff      2591.375    1819.495
#> 5        42516 841e80dffffffff      2591.375    1885.192
```
...
| **Dependencies** | None (built-in C++) | Requires `h3o` package |
