...
![Lambert azimuthal equal-area projection: chord distance
relationship](figures/fig_lambert_chord_distance.png)
...
![Projection from sphere surface to icosahedral
face](figures/fig_icosa_face_projection.png)
