...
a factor of 2 within a resolution, and by about 2.4 once the twelve
pentagons are counted. The variation follows position on the icosahedron
rather than latitude, with the smallest cells near face centres.
