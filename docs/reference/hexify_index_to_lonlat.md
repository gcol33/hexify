...
Returns the geographic coordinates of an indexed cell's center. This is
a cell-level inverse of
[`hexify_lonlat_to_index()`](https://gillescolling.com/hexify/reference/hexify_lonlat_to_index.md):
the returned point is the center, not necessarily the original input
point.
