...
[`dg_closest_res_to_spacing()`](https://gillescolling.com/hexify/reference/dg_closest_res_to_spacing.md),
...
[`hexify_print_resolutions()`](https://gillescolling.com/hexify/reference/hexify_print_resolutions.md),
