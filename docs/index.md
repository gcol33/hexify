...
Assign geographic points to hexagonal cells using the ISEA discrete
global grid system. All cells have the same area regardless of latitude.
...
- [Quick
  Start](https://gcol33.github.io/hexify/articles/quickstart.html) -
  Basic usage and concepts
- [Visualization](https://gcol33.github.io/hexify/articles/visualization.html) -
  Plotting options
- [Workflows](https://gcol33.github.io/hexify/articles/workflows.html) -
  Grid generation, spatial joins, multi-resolution analysis
