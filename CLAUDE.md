...
| `cell_numbering.cpp` | Icosa Triangle ↔ Quad IJ ↔ cell ID conversions |
...
Default ISEA3H orientation:
- Vertex 0: (11.25°, 58.28252559°)
- Azimuth: 0°

Cell count formulas:
- Aperture 3: 10 × 3^res + 2
- Aperture 4: 10 × 4^res + 2
- Aperture 7: 10 × 7^res + 2
