...
Base R `plot()`, `hexify_heatmap()` for ggplot2, and building custom maps from scratch.
...
```{r heatmap-basic, fig.width=7, fig.height=5.25}
hexify_heatmap(
  obs_hex,
  value = "count",
...
```{r heatmap-colors, fig.width=7, fig.height=5.25}
hexify_heatmap(
  obs_hex,
  value = "count",
  colors = "YlOrRd",
...
```{r heatmap-palettes, fig.width=7, fig.height=3.5, eval = requireNamespace("gridExtra", quietly = TRUE)}
...
```{r heatmap-extent, fig.width=7, fig.height=5.25}
hexify_heatmap(
  obs_hex,
  value = "count",
  xlim = c(-20, 35),
...
```{r heatmap-basemap, fig.width=7, fig.height=5.25}
...
```{r heatmap-no-basemap, fig.width=7, fig.height=5.25}
# Without basemap
hexify_heatmap(
  obs_hex,
  value = "count",
...
```{r plot-world, fig.width=7, fig.height=3.5}
plot_world(fill = "lightgray", border = "gray50")
```

### Customizing the World Map

```{r plot-world-custom, fig.width=7, fig.height=3.5}
plot_world(
  fill = "antiquewhite",
  border = "sienna",
  xlim = c(-30, 50),
...
```{r pentagon-locations, fig.width=7, fig.height=3.5}
...
```{r random-sample, fig.width=7, fig.height=3.5}
...
```{r custom-viz, fig.width=7, fig.height=5.25}
