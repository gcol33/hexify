...
An ISEA grid partitions a sphere, and `radius_km` sets which sphere. Pass a
...
This is the ISEA backend. H3 is defined for Earth's radius, which its vendored
C library carries as a constant, so `type = "h3"` takes Earth and `h3_crosswalk()`
needs Earth grids on both sides.
