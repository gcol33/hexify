...
hexify assigns geographic coordinates to equal-area hexagonal grid cells using the ISEA (Icosahedral Snyder Equal Area) discrete global grid system. Supports apertures 3, 4, and 7:
...
- Ensure same aperture (hexify supports apertures 3, 4, and 7)
