...
The first two characters always identify the base cell, so the resolution is
...
fixed in those regions, giving every cell a distinct index and guaranteeing
`index -> cell -> index` round-trips. Away from those pentagon-region cases,
the strings follow the DGGRID Z7 layout. This distinction matters when
