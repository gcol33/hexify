...
text(-0.06, 0.72, expression(italic(R)[1]), adj = 1, cex = 0.9, col = "gray40")
...
rect(bx0, by0, bx1, by1, border = "gray30")
for (v in c(0, 5, 10, 15)) {
  yv <- by0 + (by1 - by0) * v / 17.5
  lines(c(bx1, bx1 + 0.02), c(yv, yv), col = "gray30")
...
draw_quad <- function(cx, cy, q, tri_top, tri_bot, fill) {
  polygon(c(cx, cx + hw, cx, cx - hw), c(cy + hh, cy, cy - hh, cy),
          col = fill, border = "gray30", lwd = 1.5)
  lines(c(cx - hw, cx + hw), c(cy, cy), col = "gray50")
  text(cx, cy + 0.62, tri_top, cex = 0.75, col = "gray40")
  text(cx, cy - 0.62, tri_bot, cex = 0.75, col = "gray40")
