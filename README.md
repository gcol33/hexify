...
3. **Compactness** — the hexagonal tiling minimizes perimeter per unit area among all equal-area partitions of a plane ([Hales 2001](https://doi.org/10.1007/s004540010071)), which keeps edge effects small
